...
a = Analysis(
    ['main_gui.py'],
    pathex=[],
    binaries=(openai_binaries + pyqt5_binaries + _wechat_binaries),
    datas=(openai_datas + pyqt5_datas + _wechat_datas + [
    ...
    hiddenimports=[
        ...
        'PyQt5.QtCore',
        'PyQt5.QtGui',
    ] + openai_hiddenimports + pyqt5_hiddenimports + _wechat_hiddenimports,
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
